...
/**
 * Thread-safe HTTP low-level transport based on the <a href="http://square.github.io/okhttp/">OkHttp</a> package.
 * This is modified from NetHttpTransport
 */
public final class OkHttpTransport extends HttpTransport {
    ...
    protected OkHttpRequest buildRequest(String method, String url) throws IOException {
        ...
        HttpURLConnection connection = client.open(connUrl);
    ...
    public static final class Builder {
         ...
         * {@link java.security.cert.CertificateFactory#generateCertificates(InputStream)}.
         * <p/>
         * <p>
         * Example usage:
         * </p>
